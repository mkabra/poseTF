Qmv = load('/localhome/kabram/MultiViewFlyLegTracking/multiview labeling/romainJun22NewLabels.lbl','-mat');
Qs1 = load('/localhome/kabram/MultiViewFlyLegTracking/trackingApril28-14-53/track_date_2016_04_28_time_14_53_16.lbl','-mat');
Qs2 = load('/localhome/kabram/MultiViewFlyLegTracking/trackingApril28-15-23/track_date_2016_04_28_time_15_23.lbl','-mat');
...
for ndx = 1:3
  Q.movieFilesAll{ndx,1} = fullfile('/localhome/kabram',Q.movieFilesAll{ndx,1}(33:end));
